...
class ProjectList extends Component {
    ...
    dropHandler(event) {
        ...
        projectState.moveProject(prjItem, this.type === "active" ? ProjectStatus.Active : ProjectStatus.Finished);
    }
    renderContent() {
    ...
    configure() {
        ...
        projectState.addListener((projects) => {
            const filtredProjects = projects.filter((el) => {
                if (this.type === "active") {
                    return el.status === ProjectStatus.Active;
                }
                return el.status === ProjectStatus.Finished;
            });
            this.assignedProjects = filtredProjects;
            this.renderProjects();
        });
    }
    renderProjects() {
